...
// Handle new accessory submission
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['name'])) {
    ...
    $stmt = $conn->prepare("INSERT INTO accessories (name, description, price, category, image) VALUES (?, ?, ?, ?, ?)");
...
<head>
    ...
    <link rel="stylesheet" href="adminaddaccessory.css">
</head>
        ...
        <form method="POST" action="" enctype="multipart/form-data">
            ...
            <select id="category" name="category" required>
                <?php foreach ($categories as $cat): ?>
                    <option value="<?= $cat['name'] ?>"><?= $cat['name'] ?></option> <!-- Existing categories -->
                <?php endforeach; ?>
            </select>
