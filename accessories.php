...
<head>
    ...
    <title>Accessories List - <?php echo htmlspecialchars($category); ?></title>
    ...
    <div class="product-list">
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo '<a href="productdetails.php?id=' . $row["id"] . '&table=accessories">';
